...
$query = "SELECT 
            UPPER(d.codigo_docente) as codigo_docente, 
            UPPER(CONCAT(u.apellidos, ', ', u.nombres)) as nombres_completos, 
            u.dni, 
            u.email,
            UPPER(COALESCE(d.especialidad, 'No especificada')) as especialidad,
...
<head>
    <meta charset="UTF-8">
    <title>Padrón Docente - IE 22237</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        ...
        .td-code { color: #2563eb; font-weight: 600; font-family: 'DM Mono', monospace; }
...
<body onload="window.print()">
    ...
    <div class="report-header">
        <div class="brand">
            ...
            <div class="inst-info">
                ...
                <p>Reporte de Plana Docente</p>
            </div>
        </div>
        <div class="report-title">
            <h2>Padrón de Docentes</h2>
    ...
    <div class="summary-grid">
        <div class="summary-card"><span>Total Docentes</span><strong><?php echo $total; ?></strong></div>
        <div class="summary-card"><span>Docentes Activos</span><strong><?php echo $activos; ?></strong></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td class="td-code"><?php echo htmlspecialchars($doc['codigo_docente']); ?></td>
                <td class="text-bold"><?php echo htmlspecialchars($doc['nombres_completos']); ?></td>
                ...
                <td>
                    <span class="status <?php echo ($doc['estado'] == 'ACTIVO') ? 'status-activo' : 'status-inactivo'; ?>">
    ...
    <div class="footer-sign">
        <div class="metadata">
            ...
            Firma Digital: <?php echo strtoupper(substr(md5(time() . 'doc'), 0, 12)); ?>
        </div>
        <div class="sign-box">
